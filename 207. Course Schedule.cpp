...
Time: O(|V| + |E|)O(∣V∣+∣E∣), where |V| = \texttt{numCourses}∣V∣=numCourses and |E| = |\texttt{prerequisites}|∣E∣=∣prerequisites∣
Space: O(|V| + |E|)O(∣V∣+∣E∣), where |V| = \texttt{numCourses}∣V∣=numCourses and |E| = |\texttt{prerequisites}|∣E∣=∣prerequisites∣
